...
INSERT INTO `notes_list` VALUES (1,1,'Привет, я Вова!!'),(1,2,'Закрыть экзамены и отметить с Катей закрытие сессии!'),(1,3,'Убраться дома)'),(1,4,'Найти ключи'),(2,1,'Привет, я Катя!!'),(2,2,'Заказать продукты домой!'),(2,3,'Приготовить хачапури в Питере!');
